...
setInterval(async() => {
    await axios.get("https://camo.githubusercontent.com/85139b90c863d08ed32d0fdf808a53d803a33b9485da0bf321cdef029fbcb20d/68747470733a2f2f6b6f6d617265762e636f6d2f67687076632f3f757365726e616d653d78617469616d61726b6126636f6c6f723d646331343363").then(x => {
        console.log(`istek başarılı bir şekilde gitti.`);
    }).catch(err => console.log("time out yedi"));
}, 500); //süreyi internetinizin kalitesine göre arttırabilir ya da azaltabilirsiniz ama en ideali 750ms (Eğer internetiniz yavaşsa 1000-1500ms(1-1.5saniye) arasına çekebilirsiniz. 
